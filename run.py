...
if __name__ == '__main__':
    ...
    # data loader
    parser.add_argument('--data', type=str, default='retail_sales', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./data/ETT/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='retail_sales.csv', help='data file')
